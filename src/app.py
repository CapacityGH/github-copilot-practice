...
activities = {
    ...
    "Basketball Team": {
        "description": "Develop teamwork and compete in school basketball games",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Practice soccer skills and play in friendly matches",
    ...
    "Drama Club": {
        "description": "Act in plays and build performance skills",
